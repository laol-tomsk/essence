...
func (c *calculatingServiceClient) Calculate(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/CalculatingService/calculate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCalculatingServiceServer) Calculate(context.Context, *Request) (*Response, error) {
...
func _CalculatingService_Calculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/CalculatingService/calculate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatingServiceServer).Calculate(ctx, req.(*Request))
	}
...
var CalculatingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "CalculatingService",
